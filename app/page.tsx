    ...
    <div className="min-h-screen flex flex-col relative">
                      ...
                      <Label htmlFor="customerName" className="text-amber-800 text-sm flex items-center gap-2">
                        ...
                        <div className="group relative">
                          ...
                          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-10">
                            💡 Tip: Enter both first and last name for best results. If this customer has ordered
                            before, add their phone or email to ensure accurate rewards lookup.
                          </div>
                        </div>
                      </Label>
                      <Input
                    ...
                    {showCustomerSelection && customerMatches.length > 0 && (
                      <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
                              ...
                              <div className="flex justify-between items-start">
                                <div>
                                  <div className="font-medium text-gray-900">
                                    {formatCustomerDisplay(match.customer)}
                                  </div>
                        ...
                        <div className="mt-3 text-xs text-purple-600">
                          💡 Click on the customer that matches your order. If none match, you can continue to create a
                          new customer.
                        </div>
                      </div>
                    )}
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between text-lg sm:text-xl font-bold text-amber-800 bg-amber-100 p-3 rounded-lg">
                        ...
                        <span>
                          $
                          {(paymentMethod === "cash"
                            ? finalSubtotalAfterRewards + deliveryFeeAmount
                            : finalTotal
                          ).toFixed(2)}
                        </span>
                      </div>
      ...
      <div className="bg-white/95 backdrop-blur-sm border-t border-gray-200 z-20">
        <div className="p-4 sm:p-6 flex justify-center w-full">
          <div className="flex flex-wrap gap-0 w-full justify-between max-w-4xl">
            <Button
              variant="default"
